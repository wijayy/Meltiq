<div class="space-y-4">
    ...
    <flux:sidebar-content>
        <div class="grid gap-4 md:grid-cols-4">
            <div><flux:text>Nomor Visit</flux:text><flux:heading>{{ $visit->visit_no }}</flux:heading></div>
        ...
        <flux:heading size="lg" class="pt-4 text-mine-400 dark:text-mine-100">Detail Stock</flux:heading>
        <div class="flex min-w-7xl gap-3 text-sm font-semibold"><div class="w-8">#</div><div class="min-w-64 flex-1">Product</div><div class="w-28 text-right">Before</div><div class="w-28 text-right">Physical</div><div class="w-28 text-right">Terjual</div><div class="w-28 text-right">Returned</div><div class="w-28 text-right">Expired</div><div class="w-28 text-right">Delivery</div><div class="w-28 text-right">Stock Akhir</div></div>
