<div class="space-y-4">
    ...
    <flux:sidebar-content>
        <div class="grid gap-4 md:grid-cols-4">
            <div><flux:text>Nomor Production</flux:text><flux:heading>{{ $production->production_no }}</flux:heading></div>
        ...
        <flux:heading size="lg" class="pt-4 text-mine-400 dark:text-mine-100">Detail Product</flux:heading>
        <div class="flex min-w-3xl gap-4 text-sm font-semibold"><div class="w-10">#</div><div class="w-1/2">Product</div><div class="w-1/4">SKU</div><div class="w-1/4 text-right">Qty</div></div>
