...
<body class="min-h-screen bg-mine-100/60 dark:bg-neutral-800">
    <flux:sidebar sticky collapsible="mobile"
        ...
        <flux:sidebar.nav>
            ...
            <flux:sidebar.group :heading="__('Master Data')" class="grid">
                ...
                <flux:sidebar.item icon="package" :href="route('products.index')"
                    :current="request()->routeIs('products.index')" wire:navigate>
                    {{ __('Products') }}
                </flux:sidebar.item>
                <flux:sidebar.item icon="map-pin" :href="route('locations.index')"
                    :current="request()->routeIs('locations.index')" wire:navigate>
                    {{ __('Locations') }}
                </flux:sidebar.item>
            </flux:sidebar.group>
            ...
            <flux:sidebar.group :heading="__('Stok')" class="grid">
                ...
                <flux:sidebar.item icon="arrows-right-left" :href="route('stock-movements.index')"
                    :current="request()->routeIs('stock-movements.*')" wire:navigate>
                    {{ __('Stock Movement') }}
                </flux:sidebar.item>
            </flux:sidebar.group>
    ...
    <!-- Mobile User Menu -->
    <flux:header class="lg:hidden border-zinc-200 bg-zinc-50 dark:border-zinc-700 dark:bg-zinc-900 border-b">
